		...
		<>
			...
			<div className="w-[100%] bg-black bg-[url('/bg_final.webp')] bg-no-repeat bg-cover px-4 h-svh flex flex-col justify-center gap-5 ">
				...
				<div className="flex flex-col gap-5">
					...
					<h1 className="capitalize text-5xl font-semibold font-inter max-w-[30ch] text-left pt-10 text-purple-100 leading-tight">
						{/* Scaling your business begins here. */}
						<p className="text-white text-xs font-light uppercase tracking-widest">
							websites & softwares that are
						</p>
					...
					<p className="max-w-[30ch] md:flex text-left text-gray-200 leading-tight text-lg">
						<span className="font-inter font-medium text-md capitalize">
							Your vision, our mission, perfect execution
						</span>
					</p>
				</div>
				<div>
				...
				<div className="flex flex-col gap-3">
					<Link className="flex flex-col" to='/appointment'>
						<button className=" bg-white tracking-wide uppercase font-semibold rounded-full text-black font-inter text-md px-2 py-2">
							Book A Consultation
						</button>
					</Link>
				</div>
			...
			<div className="bg-black px-4 flex flex-col gap-10">
				...
				<div className="flex flex-row overflow-y-hidden gap-5 overflow-x-scroll hide-scrollbar snap-x snap-mandatory">
					{
			...
			<div className="bg-black px-4 py-20 flex flex-col gap-10">
				<div className="flex flex-col gap-4">
					<h1 className="text-5xl font-inter text-gray-100 font-semibold capitalize">
						...
						why you need a website from web consolers?
					</h1>
			...
			<div className="bg-black px-4 py-20 flex flex-col gap-20">
				<div className="flex flex-col gap-4">
					<div className="flex flex-row justify-center items-center animate-pulse">
						<img className="w-[50%]" src="/trophy.svg" alt="" />
						
					</div>
					<h1 className="text-5xl font-inter text-white font-semibold capitalize">
						1 choice to make...
					</h1>

					<p className="text-gray-200 font-inter text-sm leading-tight">
						Grow your business, make more sales and achieve your financial goals or keep struggling with your great idea.
					</p>
				</div>

				<div className="flex flex-col gap-10">
					<ChoiceCard buttonText="Get your custom website" subject="Want to sell more?" description="Is you goal getting more revenue or getting seen or even getting more people to come to you?" />


					<h1 className="text-gray-400 flex flex-col items-center uppercase font-semibold text-2xl">
						-or-
					</h1>
					...
					<div className="flex flex-col items-center text-center gap-5">
						...
						<p className="text-gray-400 text-center capitalize">
							not sure what step to take next? let us help you figure it out and choose the best for your business.
						</p>

						<div className="flex flex-col gap-2 w-full">
							<button className="capitalize bg-purple-100 font-semibold rounded-full text-black font-inter text-lg px-4 py-2">
								Get a Free Consultation
							</button>
							<p className="text-gray-500 font-inter font-semibold capitalize">
