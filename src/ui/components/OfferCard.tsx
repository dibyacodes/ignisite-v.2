...
function OfferCard({ serviceToOffer }: cardContent) {
    return (
        <>
            <div className="snap-start bg-purple-100 px-5 py-6 rounded-2xl min-w-xs md:min-w-[50ch] md:max-w-[50ch] flex flex-col gap-5 justify-between">
                ...
                <div className="flex flex-col">
                    <button className="bg-black font-semibold w-full text-white text-center font-inter capitalize py-2 px-2 rounded-md">
                        send request
                    </button>
                </div>
            </div>
