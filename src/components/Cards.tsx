            ...
            <div className="bg-gray-950/50 snap-center md:snap-none  backdrop-blur-2xl text-white flex flex-col justify-between min-w-[95%] max-w-[95%] md:min-w-[50ch] md:max-w-[50ch] rounded-2xl border-2 border-gray-200/25">
                <div className="px-6 pt-7 flex flex-col gap-5">
                    ...
                    <div hidden={cardTag || cardButtonText ? false : true} className="flex flex-row md:flex-row justify-between items-center">
                        <span hidden={cardTag ? false : true} className="capitalize w-fit rounded-xl font-medium text-sm font-inter text-blue-500">
                            {cardTag}
                        </span>
                    ...
                    <div>
                        <h1 className={`text-3xl max-w-[15ch] ${customTitleStyle ? customTitleStyle : "text-gray-100"} md:text-3xl font-inter capitalize font-semibold`}>
                            {cardTitle}
                        </h1>
                    </div>
                    ...
                    <div hidden={cardDesc ? false : true}>
                        <p className="font-inter text-gray-300 font-medium leading-tight text-sm md:text-lg">
                            {cardDesc}
                        </p>
                    </div>
